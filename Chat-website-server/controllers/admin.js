...
import { cokkieOption } from "../utils/features.js";
...
const adminLogut = TryCatch(async (req,res,next) => {
  return res
  .status(200)
...
export {allUsers,allChats,allMessages,getDashboardStats,adminLogin,adminLogut,getAdminData}